...
function toserba (barang,uang){
  ...
  if(barang === "pensil"){
    ...
    hargaBarang = 7500
  } else hargaBarang = 7000;
  var kembalian = uang-hargaBarang;
  if(uang >= hargaBarang){
    return `Berhasil membeli ${barang}, kembaliannya Rp.${kembalian}`;
  } else return `uang tidak cukup membeli ${barang}`; 
}
